...
data = pickle.load(open("/Users/nareshkhanal/Desktop/model.pkl","rb"))
model = data["model"]
...
def optimize(req: PricingRequest):
    ...
    return {
        ...
        "risk_range": {"low": float(round(opr*0.85,2)), "high": float(round(opr*1.15,2))},
        "curve": {"prices": prices, "demands": demands, "profits": profits}
    }
